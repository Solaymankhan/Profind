...
public class d_0_0_4_2_available_time extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_button= findViewById(R.id.available_time_page_back_btn_id);
